        ...
        this.editor = await Editor.make()
            .config((ctx) => {
              ...
              ctx.update(editorViewOptionsCtx, (prev) => ({
                ...prev,
                attributes: { 
                  class: 'milkdown-editor mx-auto focus:outline-hidden h-full p-2 prose prose-sm prose-bonfire break-normal max-w-none text-base-content prose-hr:!my-2 prose-br:hidden', 
                  spellcheck: 'false',
